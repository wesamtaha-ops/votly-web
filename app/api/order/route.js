...
export async function POST(req) {
  const headers = generateYouGiftHeader();
  ...
  try {
    const response = await axios.post(
      "https://b2b-sandbox.yougotagift.com/corporate/api/v2-4/orders/",
      {
        ...
        amount: 200,
        country: "AE",
        receiver_name: "Mohamad",
        receiver_email: "mhdalalwan@gmail.com",
        receiver_phone: "+971585931210",
        message: "a gift from votly!",
