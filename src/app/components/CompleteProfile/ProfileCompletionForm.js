...
const ProfileCompletionForm = ({ profile, onSubmit }) => {
  ...
  const [dataLoading, setDataLoading] = useState(true); // New loading state for form data
  ...
  useEffect(() => {
    if (profile) {
      // Simulating data load with a small delay
      setTimeout(() => {
        reset({
        ...
        setDataLoading(false); // Stop loading once data is loaded
        ...
        <>
          ...
          <form
            ...
            <TextField
              ...
              <MenuItem value='Comoran'>
                {isArabic ? 'قمري' : 'Comoran'}
              </MenuItem>
            ...
            <TextField
              ...
              <MenuItem
                value={isArabic ? 'أفضل عدم القول' : 'Prefer not to say'}>
                {isArabic ? 'أفضل عدم القول' : 'Prefer not to say'}
              </MenuItem>
            </TextField>
            ...
            <TextField
              ...
              <MenuItem value='2 cars'>
                {isArabic ? 'سيارتان' : '2 cars'}
              </MenuItem>
